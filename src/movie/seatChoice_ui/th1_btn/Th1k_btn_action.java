...
public class Th1k_btn_action implements ActionListener {

   Th1k_btn btn;


   public Th1k_btn_action(Th1k_btn btn) {
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if(SeatChoice_1.th1k_btn_soldout[index - 1]) 
      {
      ...
      {
         if(SeatChoice_1.th1k_btn_selected[index - 1])
         {
            SeatChoice_1.th1k_btn_selected[index - 1] = false;
            if(index < 14) {
            ...
            SeatChoice_1.ticket_price -= SeatChoice_1.th1k_btn_price[index - 1];
         ...
         else
         {
            ...
            {
               SeatChoice_1.th1k_btn_selected[index - 1] = true;
