...
public class Th1g_btn_action implements ActionListener {

   Th1g_btn btn;


   public Th1g_btn_action(Th1g_btn btn) {
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if(SeatChoice_1.th1g_btn_soldout[index - 1]) 
      {
      ...
      {
         if(SeatChoice_1.th1g_btn_selected[index - 1])
         {
            SeatChoice_1.th1g_btn_selected[index - 1] = false;
            btn.setBackground(new Color(0x404040));
            SeatChoice_1.selected_cnt--;
            SeatChoice_1.ticket_price -= SeatChoice_1.th1g_btn_price[index - 1];
         ...
         else
         {
            ...
            {
               SeatChoice_1.th1g_btn_selected[index - 1] = true;
