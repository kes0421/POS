...
public class Th1b_btn_action implements ActionListener {

   Th1b_btn btn;


   public Th1b_btn_action(Th1b_btn btn) {
      this.btn = btn;
   }
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if(SeatChoice_1.th1b_btn_soldout[index - 1]) 
      {
      ...
      {
         if(SeatChoice_1.th1b_btn_selected[index - 1])
         {
