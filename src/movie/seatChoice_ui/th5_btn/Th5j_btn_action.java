...
public class Th5j_btn_action implements ActionListener {

   Th5j_btn btn;


   public Th5j_btn_action(Th5j_btn btn) {
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if(SeatChoice_5.th5j_btn_soldout[index - 1]) 
      {
      ...
      {
         if(SeatChoice_5.th5j_btn_selected[index - 1])
         {
            if(index > 2) 
            {
               SeatChoice_5.th5j_btn_selected[index - 1] = false;
            ...
            SeatChoice_5.ticket_price -= SeatChoice_5.th5j_btn_price[index - 1];
         ...
         else
         {
            ...
            {
               SeatChoice_5.th5j_btn_selected[index - 1] = true;
