...
public class Th5m_btn_action implements ActionListener {

   Th5m_btn btn;


   public Th5m_btn_action(Th5m_btn btn) {
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if(SeatChoice_5.th5m_btn_soldout[index - 1]) 
      {
      ...
      {
         if(SeatChoice_5.th5m_btn_selected[index - 1])
         {

            btn.setBackground(new Color(0xFF66B2));
            SeatChoice_5.selected_cnt--;
            SeatChoice_5.ticket_price -= SeatChoice_5.th5m_btn_price[index - 1];
         ...
         else
         {
            ...
            {
               SeatChoice_5.th5m_btn_selected[index - 1] = true;
