...
public class Th5k_btn_action implements ActionListener {

   Th5k_btn btn;


   public Th5k_btn_action(Th5k_btn btn) {
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if(SeatChoice_5.th5k_btn_soldout[index - 1]) 
      {
      ...
      {
         if(SeatChoice_5.th5k_btn_selected[index - 1])
         {

            SeatChoice_5.th5k_btn_selected[index - 1] = false;
            if(index < 15) {
            ...
            SeatChoice_5.ticket_price -= SeatChoice_5.th5k_btn_price[index - 1];
         ...
         else
         {
            ...
            {
               SeatChoice_5.th5k_btn_selected[index - 1] = true;
