...
public class Th5f_btn_action implements ActionListener {

   Th5f_btn btn;


   public Th5f_btn_action(Th5f_btn btn) {
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if(SeatChoice_5.th5f_btn_soldout[index - 1]) 
      {
      ...
      {
         if(SeatChoice_5.th5f_btn_selected[index - 1])
         {
            SeatChoice_5.th5f_btn_selected[index - 1] = false;
            btn.setBackground(new Color(0x404040));
            SeatChoice_5.selected_cnt--;
            SeatChoice_5.ticket_price -= SeatChoice_5.th5f_btn_price[index - 1];
         ...
         else
         {
            ...
            {
               SeatChoice_5.th5f_btn_selected[index - 1] = true;
