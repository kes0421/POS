...
public class Th2i_btn_action implements ActionListener {

   Th2i_btn btn;


   public Th2i_btn_action(Th2i_btn btn) {
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if(SeatChoice_2.th2i_btn_soldout[index - 1]) 
      {
      ...
      {
         if(SeatChoice_2.th2i_btn_selected[index - 1])
         {
            if(index > 2) 
            {
               SeatChoice_2.th2i_btn_selected[index - 1] = false;
            ...
            SeatChoice_2.ticket_price -= SeatChoice_2.th2i_btn_price[index - 1];
         ...
         else
         {
            ...
            {
               SeatChoice_2.th2i_btn_selected[index - 1] = true;
