...
public class Th2f_btn_action implements ActionListener {

   Th2f_btn btn;


   public Th2f_btn_action(Th2f_btn btn) {
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if(SeatChoice_2.th2f_btn_soldout[index - 1]) 
      {
      ...
      {
         if(SeatChoice_2.th2f_btn_selected[index - 1])
         {
            SeatChoice_2.th2f_btn_selected[index - 1] = false;
            btn.setBackground(new Color(0x404040));
            SeatChoice_2.selected_cnt--;
            SeatChoice_2.ticket_price -= SeatChoice_2.th2f_btn_price[index - 1];
         ...
         else
         {
            ...
            {
               SeatChoice_2.th2f_btn_selected[index - 1] = true;
