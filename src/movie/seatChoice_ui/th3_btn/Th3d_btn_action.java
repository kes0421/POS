...
public class Th3d_btn_action implements ActionListener {

   Th3d_btn btn;


   public Th3d_btn_action(Th3d_btn btn) {
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if(SeatChoice_3.th3d_btn_soldout[index - 1]) 
      {
      ...
      {
         if(SeatChoice_3.th3d_btn_selected[index - 1])
         {
            SeatChoice_3.th3d_btn_selected[index - 1] = false;
            btn.setBackground(new Color(0x404040));
            SeatChoice_3.selected_cnt--;
            SeatChoice_3.ticket_price -= SeatChoice_3.th3d_btn_price[index - 1];
         ...
         else
         {
            ...
            {
               SeatChoice_3.th3d_btn_selected[index - 1] = true;
