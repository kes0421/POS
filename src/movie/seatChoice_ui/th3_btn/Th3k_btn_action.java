...
public class Th3k_btn_action implements ActionListener {

   Th3k_btn btn;


   public Th3k_btn_action(Th3k_btn btn) {
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if(SeatChoice_3.th3k_btn_soldout[index - 1]) 
      {
      ...
      {
         if(SeatChoice_3.th3k_btn_selected[index - 1])
         {
            if(index == 15 || index == 16)
            {
               SeatChoice_3.th3k_btn_selected[index - 1] = false;
            ...
            SeatChoice_3.ticket_price -= SeatChoice_3.th3k_btn_price[index - 1];
         ...
         else
         {
            ...
            {
               SeatChoice_3.th3k_btn_selected[index - 1] = true;
