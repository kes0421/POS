...
public class Th3m_btn_action implements ActionListener {

   Th3m_btn btn;


   public Th3m_btn_action(Th3m_btn btn) {
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if(SeatChoice_3.th3m_btn_soldout[index - 1]) 
      {
      ...
      {
         if(SeatChoice_3.th3m_btn_selected[index - 1])
         {
            SeatChoice_3.th3m_btn_selected[index - 1] = false;
            btn.setBackground(new Color(0xFF66B2));
            SeatChoice_3.selected_cnt--;
            SeatChoice_3.ticket_price -= SeatChoice_3.th3m_btn_price[index - 1];
         ...
         else
         {
            ...
            {
               SeatChoice_3.th3m_btn_selected[index - 1] = true;
