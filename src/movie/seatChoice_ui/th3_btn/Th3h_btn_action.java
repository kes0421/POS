...
public class Th3h_btn_action implements ActionListener {

   Th3h_btn btn;


   public Th3h_btn_action(Th3h_btn btn) {
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if(SeatChoice_3.th3h_btn_soldout[index - 1]) 
      {
      ...
      else
      {
         ...
         if(SeatChoice_3.th3h_btn_selected[index - 1])
         {
            SeatChoice_3.th3h_btn_selected[index - 1] = false;
            btn.setBackground(new Color(0x404040));
            SeatChoice_3.selected_cnt--;
            SeatChoice_3.ticket_price -= SeatChoice_3.th3h_btn_price[index - 1];
         ...
         else
         {
            ...
            {
               SeatChoice_3.th3h_btn_selected[index - 1] = true;
