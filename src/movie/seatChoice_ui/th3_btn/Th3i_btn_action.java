...
public class Th3i_btn_action implements ActionListener {

   Th3i_btn btn;


   public Th3i_btn_action(Th3i_btn btn) {
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if(SeatChoice_3.th3i_btn_soldout[index - 1]) 
      {
      ...
      {
         if(SeatChoice_3.th3i_btn_selected[index - 1])
         {
            if(index > 2) 
            {
               SeatChoice_3.th3i_btn_selected[index - 1] = false;
            ...
            SeatChoice_3.ticket_price -= SeatChoice_3.th3i_btn_price[index - 1];
         ...
         else
         {
            ...
            {
               SeatChoice_3.th3i_btn_selected[index - 1] = true;
