...
public class Th3l_btn_action implements ActionListener {

   Th3l_btn btn;


   public Th3l_btn_action(Th3l_btn btn) {
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if(SeatChoice_3.th3l_btn_soldout[index - 1]) 
      {
      ...
      {
         if(SeatChoice_3.th3l_btn_selected[index - 1])
         {
            SeatChoice_3.th3l_btn_selected[index - 1] = false;
            if(index < 15) {
            ...
            SeatChoice_3.ticket_price -= SeatChoice_3.th3l_btn_price[index - 1];
         ...
         else
         {
            ...
            {
               SeatChoice_3.th3l_btn_selected[index - 1] = true;
