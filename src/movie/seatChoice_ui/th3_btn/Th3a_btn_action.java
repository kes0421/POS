...
public class Th3a_btn_action implements ActionListener {

   Th3a_btn btn;


   public Th3a_btn_action(Th3a_btn btn) {
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if(SeatChoice_3.th3a_btn_soldout[index - 1]) 
      {
      ...
      {
         if(SeatChoice_3.th3a_btn_selected[index - 1])
         {
            SeatChoice_3.th3a_btn_selected[index - 1] = false;
            if( index > 10)
            {
         ...
         else
         {
            if(SeatChoice_3.peoples > SeatChoice_3.selected_cnt)
            {
               ...
               else
               {
                  ...
                  {
                     if(PeopleCheck.disable_cnt > SeatChoice_3.disable_btn_cnt)
                     {
                        SeatChoice_3.th3a_btn_selected[index - 1] = true;
                        btn.setBackground(new Color(0xFF3333));
                        SeatChoice_3.disable_btn_cnt++;
