...
public class Th3b_btn_action implements ActionListener {

   Th3b_btn btn;


   public Th3b_btn_action(Th3b_btn btn) {
      this.btn = btn;
   }
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if(SeatChoice_3.th3b_btn_soldout[index - 1]) 
      {
      ...
      {
         if(SeatChoice_3.th3b_btn_selected[index - 1])
         {
            SeatChoice_3.th3b_btn_selected[index - 1] = false;
            btn.setBackground(new Color(0xFFB266));
            SeatChoice_3.selected_cnt--;
            SeatChoice_3.ticket_price -= SeatChoice_3.th3b_btn_price[index - 1];
         ...
         else
         {
            ...
            {
               SeatChoice_3.th3b_btn_selected[index - 1] = true;
