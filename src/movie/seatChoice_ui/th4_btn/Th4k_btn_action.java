...
public class Th4k_btn_action implements ActionListener {

   Th4k_btn btn;


   public Th4k_btn_action(Th4k_btn btn) {
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if(SeatChoice_4.th4k_btn_soldout[index - 1]) 
      {
      ...
      {
         if(SeatChoice_4.th4k_btn_selected[index - 1])
         {
