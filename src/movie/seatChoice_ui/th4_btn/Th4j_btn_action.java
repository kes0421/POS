...
public class Th4j_btn_action implements ActionListener {

   Th4j_btn btn;


   public Th4j_btn_action(Th4j_btn btn) {
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if(SeatChoice_4.th4j_btn_soldout[index - 1]) 
      {
      ...
      {
         if(SeatChoice_4.th4j_btn_selected[index - 1])
         {
            if(index > 2) 
            {
               SeatChoice_4.th4j_btn_selected[index - 1] = false;
            ...
            SeatChoice_4.ticket_price -= SeatChoice_4.th4j_btn_price[index - 1];
         ...
         else
         {
            ...
            {
               SeatChoice_4.th4j_btn_selected[index - 1] = true;
