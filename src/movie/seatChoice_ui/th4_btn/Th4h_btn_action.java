...
public class Th4h_btn_action implements ActionListener {

   Th4h_btn btn;


   public Th4h_btn_action(Th4h_btn btn) {
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if(SeatChoice_4.th4h_btn_soldout[index - 1]) 
      {
      ...
      {
         if(SeatChoice_4.th4h_btn_selected[index - 1])
         {
            SeatChoice_4.th4h_btn_selected[index - 1] = false;
            btn.setBackground(new Color(0x404040));
            SeatChoice_4.selected_cnt--;
            SeatChoice_4.ticket_price -= SeatChoice_4.th4h_btn_price[index - 1];
         ...
         else
         {
            ...
            {
               SeatChoice_4.th4h_btn_selected[index - 1] = true;
