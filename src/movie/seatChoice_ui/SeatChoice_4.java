...
import movie.seatChoice_ui.th_payment_btn.Th4_payment_btn;
...
public class SeatChoice_4 extends CgvFrame {
   ...
   public static int[] th4a_btn_price;
   public static int[] th4b_btn_price;
   public static int[] th4c_btn_price;
   public static int[] th4d_btn_price;
   public static int[] th4e_btn_price;
   public static int[] th4f_btn_price;
   public static int[] th4g_btn_price;
   public static int[] th4h_btn_price;
   public static int[] th4i_btn_price;
   public static int[] th4j_btn_price;
   public static int[] th4k_btn_price;
   
   public static String[] th4a_btn_name;
   public static String[] th4b_btn_name;
   public static String[] th4c_btn_name;
   public static String[] th4d_btn_name;
   public static String[] th4e_btn_name;
   public static String[] th4f_btn_name;
   public static String[] th4g_btn_name;
   public static String[] th4h_btn_name;
   public static String[] th4i_btn_name;
   public static String[] th4j_btn_name;
   public static String[] th4k_btn_name;
   ...
   public SeatChoice_4() {
      ...
      Th4_payment_btn payment = new Th4_payment_btn(btn);
      ...
      th4a_btn_price = new int[15];
      th4b_btn_price = new int[15];
      th4c_btn_price = new int[15];
      th4d_btn_price = new int[15];
      th4e_btn_price = new int[15];
      th4f_btn_price = new int[15];
      th4g_btn_price = new int[15];
      th4h_btn_price = new int[15];
      th4i_btn_price = new int[15];
      th4j_btn_price = new int[15];
      th4k_btn_price = new int[15];
      ...
      if(DateSelectButton.day_of_week == 7 || DateSelectButton.day_of_week == 1)
      {
         for(int i = 0; i < 15; i++) {
            if(i == 2 || i == 3) 
            {
               th4a_btn_price[i] = 12000;
            }
            if(i > 5 && i < 13)
            {
               th4a_btn_price[i] = 13000;
            }
            if(i > 1 && i < 13) 
            {
               th4b_btn_price[i] = 13000;
               th4c_btn_price[i] = 13000;
               th4d_btn_price[i] = 13000;
               th4e_btn_price[i] = 13000;
               th4f_btn_price[i] = 13000;
               th4g_btn_price[i] = 13000;
               th4h_btn_price[i] = 13000;
               th4i_btn_price[i] = 13000;
               th4j_btn_price[i] = 13000;
            }
            if( i > 1 && i < 13)
            {
               th4k_btn_price[i] = 14000;

            }

            if (i == 0 || i == 1)
            {
                 th4i_btn_price[i] = 14000;
               th4j_btn_price[i] = 14000;
               th4k_btn_price[i] = 14000;
            }
      ...
      else
      {
         if(SelectMovieMain.movie_start_time >= 6 && SelectMovieMain.movie_start_time <= 10 )
         {
              for(int i = 0; i < 15; i++) {
                ...
                if(i > 1 && i < 13) 
                {
                   th4b_btn_price[i] = 9000;
                   th4c_btn_price[i] = 9000;
                   th4d_btn_price[i] = 9000;
                   th4e_btn_price[i] = 9000;
                   th4f_btn_price[i] = 9000;
                   th4g_btn_price[i] = 9000;
                   th4h_btn_price[i] = 9000;
                   th4i_btn_price[i] = 9000;
                   th4j_btn_price[i] = 9000;
                }
                if( i > 1 && i < 13)
                {
                   th4k_btn_price[i] = 9000;
         ...
         else
         {
              for(int i = 0; i < 15; i++) {
                ...
                if(i > 1 && i < 13) 
                {
                   th4b_btn_price[i] = 12000;
                   th4c_btn_price[i] = 12000;
                   th4d_btn_price[i] = 12000;
                   th4e_btn_price[i] = 12000;
                   th4f_btn_price[i] = 12000;
                   th4g_btn_price[i] = 12000;
                   th4h_btn_price[i] = 12000;
                   th4i_btn_price[i] = 12000;
                   th4j_btn_price[i] = 12000;
                }
                if( i > 1 && i < 13)
                {
                   th4k_btn_price[i] = 13000;
      ...
      th4a_btn_name = new String[15];
      th4b_btn_name = new String[15];
      th4c_btn_name = new String[15];
      th4d_btn_name = new String[15];
      th4e_btn_name = new String[15];
      th4f_btn_name = new String[15];
      th4g_btn_name = new String[15];
      th4h_btn_name = new String[15];
      th4i_btn_name = new String[15];
      th4j_btn_name = new String[15];
      th4k_btn_name = new String[15];
      
      for(int i = 0 ; i < 15; i++) {
         if(i == 2 || i == 3)
         {
            th4a_btn_name[i] = "장애인석";
         }
         ...
         if (i == 0 || i == 1)
         {
            th4i_btn_name[i] = "SWEETBOX";
            th4j_btn_name[i] = "SWEETBOX";
            th4k_btn_name[i] = "SWEETBOX";
