...
public class Th6f_btn_action implements ActionListener {

   Th6f_btn btn;


   public Th6f_btn_action(Th6f_btn btn) {
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if(SeatChoice_6.th6f_btn_soldout[index - 1]) 
      {
      ...
      {
         if(SeatChoice_6.th6f_btn_selected[index - 1])
         {
            SeatChoice_6.th6f_btn_selected[index - 1] = false;
            btn.setBackground(new Color(0x404040));
            SeatChoice_6.selected_cnt--;
            SeatChoice_6.ticket_price -= SeatChoice_6.th6f_btn_price[index - 1];
         ...
         else
         {
            ...
            {
               SeatChoice_6.th6f_btn_selected[index - 1] = true;
