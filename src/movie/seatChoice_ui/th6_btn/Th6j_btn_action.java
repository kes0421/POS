...
public class Th6j_btn_action implements ActionListener {

   Th6j_btn btn;


   public Th6j_btn_action(Th6j_btn btn) {
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if(SeatChoice_6.th6j_btn_soldout[index - 1]) 
      {
      ...
      {
         if(SeatChoice_6.th6j_btn_selected[index - 1])
         {
            if(index > 2) 
            {
               SeatChoice_6.th6j_btn_selected[index - 1] = false;
            ...
            SeatChoice_6.ticket_price -= SeatChoice_6.th6j_btn_price[index - 1];
         ...
         else
         {
            ...
            {
               SeatChoice_6.th6j_btn_selected[index - 1] = true;
